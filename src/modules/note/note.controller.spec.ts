...
describe('NoteController', () => {
  ...
  describe('GET /note', () => {
    it('should return all notes for an admin', async () => {
      ...
      jest
        .spyOn(noteService, 'listByUser')
        .mockImplementation(async () => [notes[0]]);
    ...
    it('should return notes for a normal user', async () => {
      ...
      jest
        .spyOn(noteService, 'listAll')
        .mockImplementation(async () => [myNote, otherNote]);
      jest
        .spyOn(noteService, 'listByUser')
        .mockImplementation(async () => [myNote]);
      const res = await noteController.listNote(user);
    ...
    describe('POST /note', () => {
      it('should create new note', async () => {
        ...
        jest.spyOn(noteService, 'create').mockImplementation(async () => note);
        const noteCreated = await noteController.createNote(user, {
          title: note.title,
          body: note.body,
        });
